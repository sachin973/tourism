...
import htl1 from '../images/DWW/Promo/htl1.jpg';
import htl2 from '../images/DWW/Promo/htl2.jpg';
import htl3 from '../images/DWW/Promo/htl3.jpg';
import htl4 from '../images/DWW/Promo/htl4.jpg';
                ...
                <div className="blogs flex flex-col gap-5">
                    ...
                    <Slider {...settings}>
                        <div className='card-div '>
                            <div className='card_one'>
                                <div className='hover_effect'>
                                    <Image src={htl1} alt='Image'></Image>
                                </div>
                        ...
                        <div className='card-div '>
                            <div className='card_one'>
                                <div className='hover_effect'>
                                    <Image src={htl2} alt='Image'></Image>
                                </div>
                                <h3 className='card_one_title'>
                                    Spectrum of the seas
                                </h3>
                        ...
                        <div className='card-div '>
                            <div className='card_one'>
                                <div className='hover_effect'>
                                    <Image src={htl3} alt='Image'></Image>
                                </div>
                                <h3 className='card_one_title'>
                                    Spectrum of the seas
                                </h3>
                        ...
                        <div className='card-div '>
                            <div className='card_one'>
                                <div className='hover_effect'>
                                    <Image src={htl4} alt='Image'></Image>
                                </div>
                                <h3 className='card_one_title'>
                                    Spectrum of the seas
                                </h3>
