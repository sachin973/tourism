                ...
                <div className="blogs flex flex-col gap-5">
                    ...
                    <Slider {...settings}>
                        <div className='card-div '>
                            <div className='card_one'>
                                <div className='hover_effect'>
                                    <img src="../images/DWW/Promo/desti1.jpg" alt='img'></img>
                                </div>
                        ...
                        <div className='card-div '>
                            <div className='card_one'>
                                <div className='hover_effect'>
                                    <img src="../images/DWW/Promo/desti2.jpg" alt='img'></img>
                                </div>
                                <h3 className='card_one_title'>
                                    10 Satwa Liar Menakjubkan di New South Wales
                                </h3>
                        ...
                        <div className='card-div '>
                            <div className='card_one'>
                                <div className='hover_effect'>
                                    <img src="../images/DWW/Promo/desti3.jpg" alt='img'></img>
                                </div>
                                <h3 className='card_one_title'>
                                    10 Satwa Liar Menakjubkan di New South Wales
                                </h3>
                        ...
                        <div className='card-div '>
                            <div className='card_one'>
                                <div className='hover_effect'>
                                    <img src="../images/DWW/Promo/desti4.jpg" alt='img'></img>
                                </div>
                                <h3 className='card_one_title'>
                                    10 Satwa Liar Menakjubkan di New South Wales
                                </h3>
                        ...
                        <div className='card-div '>
                            <div className='card_one'>
                                <div className='hover_effect'>
                                    <img src="../images/DWW/Promo/desti5.jpg" alt='img'></img>
                                </div>
                                <h3 className='card_one_title'>
                                    10 Satwa Liar Menakjubkan di New South Wales
                                </h3>
